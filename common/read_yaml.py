...
new_report_title_kuan_7 = yaml_para.read_yaml('new_report_title_kuan_7')
new_report_title_kuan_8 = yaml_para.read_yaml('new_report_title_kuan_8')
new_report_title_kuan_9 = yaml_para.read_yaml('new_report_title_kuan_9')
...
new_report_title_jian_waishang_hebing_tuibian_1 = yaml_para.read_yaml('new_report_title_jian_waishang_hebing_tuibian_1')
...
new_report_title_wan_tuibian_10 = yaml_para.read_yaml('new_report_title_wan_tuibian_10')
