...
from common.read_yaml import new_report_title_jian_wai_shang_1, new_report_title_jian_wai_shang_2, new_report_title_jian_wai_shang_3, new_report_title_jian_wai_shang_4
...
class TestAddReportJianWaiShang:
    ...
    @allure.story("报告添加-印象标题-左/右肩关节Bankart-Hill-Sachs损伤、左/右肩关节反Bankart-反Hill-Sachs损伤")
